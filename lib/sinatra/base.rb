  ...
  module Templates
    ...
    def coffee(template, options={}, locals={})
      ...
      if options.has_key? :preprocess
        @preferred_extension = "coffee." + options[:preprocess].to_s
        data = render options[:preprocess], template, options, locals
        options.merge! :layout => false, :default_content_type => :js
        render :coffee, data, options, locals
      else
      ...
      template_cache.fetch engine, data, options do
        ...
        when data.is_a?(Symbol)
          ...
          if body
            ...
            @preferred_extension = engine.to_s unless options.has_key? :preprocess
